...
\begin{itemize}
  ...
  \item Initialize (Startup):
		No new changes were made to the start up task
    \begin{itemize}
  ...
  \item DisplayTask:
		No new chagnes were made to the display task
    \begin{itemize}
  ...
  \item Changes to Schedule:
		The Schedule function has been replaced by the RTOS scheduler
    \begin{itemize}
  ...
  \item Changes to StatusTask:
	...
	\item New Task: EKG Process
		The EKG Process function transforms the raw EKg sampled sequence and converts it to a single frequency for analysis
		\begin{itemize}
