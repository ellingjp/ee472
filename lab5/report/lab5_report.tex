...
the remote terminal.
    ...
    \begin{figure}[h]
      \centering
			\fbox{
      \includegraphics[width=0.7\textwidth]{../design/high_level_data_flow.png}
		}
...
five minor cycle counts. The next
    ...
    20\% battery, and the device is not in a warning or alarm state then the
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=0.7\textwidth]{../design/warning_control_flow.jpg}
			\caption{control flow for warning task}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{../design/local_control_flow.jpg}
